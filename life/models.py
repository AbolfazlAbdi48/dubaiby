...
class LifeObj(models.Model):
    image = models.ImageField(verbose_name=_('Thumbnail'), upload_to='life/images/')
    ...
    class Meta:
        verbose_name_plural = _('1. Life Objects')
        verbose_name = _('1. Life Object')
